...
export function GenericAccordionCard({
  ...
  const collapsedContent = React.Children.toArray(children).find(
    child => React.isValidElement(child) && child.type === AccordionCollapsedContentSlot
  )
  
  const expandedContent = React.Children.toArray(children).find(
    child => React.isValidElement(child) && child.type === AccordionExpandedContentSlot
  )
...
export function AccordionLeftControls({ children, className }: AccordionLeftControlsProps) {
  return (
...
export function AccordionCollapsedContentSlot({ children, className }: AccordionCollapsedContentSlotProps) {
...
export function AccordionExpandedContentSlot({ children, className }: AccordionExpandedContentSlotProps) {
  return <div className={className}>{children}</div>
} 