...
import { Star, Shield, Zap, Heart, Brain, Target, Flame, Droplets, Skull, Sword, BookOpen, Eye, Hand } from 'lucide-react'
      ...
      <AccordionExpandedContentSlot>
        <div className="space-y-4">
          ...
          {originalRace?.startingStats && (
            <div>
              <h5 className="text-lg font-medium text-foreground mb-3">Starting Stats</h5>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {Object.entries(originalRace.startingStats).map(([stat, value]) => (
                  <div key={stat} className="flex items-center justify-between p-3 rounded-lg border bg-muted/30">
