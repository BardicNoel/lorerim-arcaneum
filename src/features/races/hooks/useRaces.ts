...
import { validateRaceData, sanitizeRaceData, testDataTransformation } from "../utils/validation";
...
export function useRaces() {
  ...
  const races = useMemo(() => {
    ...
    if (!testResult.success) {
      ...
      console.log(`Successfully transformed ${testResult.transformedCount} races`)
    }
