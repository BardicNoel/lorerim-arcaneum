...
function detectKeywordType(
  ...
  if (
    [
      ...
      'lockpicking',
      'pickpocket',
    ].some(skill => lowerKeyword.includes(skill))
  ) {
    return 'skill'
  }
  ...
  if (
    [
      ...
      'battle cry',
    ].some(ability => lowerKeyword.includes(ability))
  ) {
    return 'ability'
  }
  ...
  // Trait keywords
  if (
    ['strong stomach', 'beast race', 'bleeds', 'natural'].some(trait =>
