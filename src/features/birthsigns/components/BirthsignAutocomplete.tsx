...
export function BirthsignAutocomplete({
  ...
  const handleBirthsignSelect = useCallback(
    (birthsign: Birthsign) => {
      onSelect(birthsign)
  ...
  const handleDesktopBirthsignSelect = useCallback(
  ...
  const renderBirthsignListItem = useCallback(
    (birthsign: Birthsign, isSelected: boolean, onSelect: () => void) => (
      <Button
        variant="ghost"
