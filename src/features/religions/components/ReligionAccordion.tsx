 ...
 */
export function renderReligionHeader(item: PlayerCreationItem, originalReligion?: Religion) {
  return (
    <>
 ...
 */
export function renderReligionCollapsedContent(item: PlayerCreationItem, originalReligion?: Religion) {
 ...
 */
export function renderReligionExpandedContent(item: PlayerCreationItem, originalReligion?: Religion) {
...
export function ReligionAccordion({ 
  ...
  return (
    <GenericAccordionCard
      ...
      onToggle={onToggle || (() => {})}
      renderHeader={(item) => renderReligionHeader(item, originalReligion)}
      renderCollapsedContent={(item) => renderReligionCollapsedContent(item, originalReligion)}
      renderExpandedContent={(item) => renderReligionExpandedContent(item, originalReligion)}
      renderLeftControls={(item) => renderReligionLeftControls(item)}
      className={className}
    />
  )
} 